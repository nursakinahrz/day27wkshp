...
Model model) {
    ...
    // Review rInput = new Review(username, Integer.parseInt(rating), comment, Integer.parseInt(gameId), boardGameName);
    // Review r = new Review( form.getFirst("user"),);
    ...
    Review insertedRv = rvSvc.insertReview(r);
